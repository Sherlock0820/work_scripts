...
async def tj_getinfo(page, company_name, login=None):
    ...
    try:
        ...
        await page.locator('#app > div > div._1ukL5 > div._1L2jN > div._1ocgW > div:nth-child(2)').click()
        await page.locator(
        ...
        await page.locator(
            ...
            login['password'])
        await page.locator(
            '#app > div > div._1ukL5 > div.ant-tabs.ant-tabs-top.ant-tabs-line > div.ant-tabs-content.ant-tabs-content-animated.ant-tabs-top-content > div.ant-tabs-tabpane.ant-tabs-tabpane-active > section > form > div._201kd > label > span.ant-checkbox > input').click()
        await page.locator(
            '#app > div > div._1ukL5 > div.ant-tabs.ant-tabs-top.ant-tabs-line > div.ant-tabs-content.ant-tabs-content-animated.ant-tabs-top-content > div.ant-tabs-tabpane.ant-tabs-tabpane-active > section > form > div:nth-child(4) > div > div > span > span > button').click()
        await page.wait_for_timeout(timeout=500)
        await page.locator(
            '#app-content > div._2_xLc > div._1MQTa > div > div > div.d9QSC > div._1_Kp9 > a:nth-child(1)').click()
        ...
        async with page.context.expect_page() as new_page_info:
            await page.locator(
                '#app-content > div > div > div._1L8tl > div._2LGEv > div._3q8AG > div._3uuyR > div > div > div:nth-child(1) > div > div > div > div > div > div > table > tbody > tr:nth-child(1) > td:nth-child(2) > div > section > div._7AsBn._1ccTs > div._2BCLE > h3 > a').click()
        new_page = await new_page_info.value
        await new_page.wait_for_timeout(timeout=1500)
        await new_page.locator(
            '#___reactour > div:nth-child(3) > div > section > div.GnkN5U6pZoc4jIizt2WK2 > div > button').click()
        await new_page.locator(
            '#___reactour > div:nth-child(3) > div > section > div.GnkN5U6pZoc4jIizt2WK2 > div:nth-child(3) > button').click()
        await new_page.locator(
            '#enterprise-details > div._27SC6.Cue1l.IXxa8 > div > div.ScrollbarsCustom-Wrapper > div > div > div._3Soam > div > div.cKi1K > div._1Y9j8 > div > ul > li:nth-child(6) > div').click()
